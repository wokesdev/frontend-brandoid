<div class="modal fade" id="editModal" aria-hidden="true" tabindex="-1" role="dialog" aria-labelledby="editModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header"><h5 class="modal-title" id="titleModal">Edit Penerimaan Kas</h5><button type="button" class="close" data-dismiss="modal">&times;</button></div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="coaIdEdit" class="col-sm-12 control-label">Akun Penerimaan Kas</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12"><input type="text" class="form-control" id="keteranganEdit" name="keterangan" placeholder="Contoh: tambah modal" required></div>
                            </div>
                            <div class="form-group">
