...
$(document).ready(function () {
    ...
    $('.show-detail').click(function () {
        ...
        $.ajax({
            ...
            success: function (data) {
                $('.header-text').text('Di bawah ini adalah rincian pembelian untuk nomor pembelian ' + data['purchase']['nomor_pembelian'] + ':');
    ...
    $('.edit').click(function () {
        ...
        $.ajax({
            ...
            beforeSend: function () {
                ...
                $('#editForm').attr('action', "purchase/" + id);
    ...
    $('.delete').click(function () {
        ...
        swal({
            title: 'Are you sure?',
            text: "Linked purchase's details will also be deleted!",
            icon: 'warning',
            buttons:{
                confirm: {
                    text: 'Yes, of course!',
