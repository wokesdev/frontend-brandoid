    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createForm" name="createForm" class="form-horizontal" autocomplete="off" action="{{ route('user.sale.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div id="mainField" class="col-sm-6">
                            <div class="form-group">
                                <label for="coaId" class="col-sm-12 control-label">Akun Penjualan</label>
                                <div class="col-sm-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12"><input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Contoh: jual barang" required></div>
                            </div>
