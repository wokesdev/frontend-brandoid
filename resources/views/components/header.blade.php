<div class="logo-header" data-background-color="blue">
    <a href="{{ request()->routeIs('admin*') ? route('admin.dashboard') : route('user.dashboard') }}" class="logo"><img src="{{ asset('atlantis-assets/img/logo1.png') }}" alt="navbar brand" class="navbar-brand"></a>
