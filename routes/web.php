...
Route::middleware(['is.banned', 'is.admin'])->namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
...
Route::middleware(['is.banned', 'is.auth'])->namespace('User')->name('user.')->group(function () {
    Route::get('/dashboard', 'DashboardController@index')->name('dashboard');
